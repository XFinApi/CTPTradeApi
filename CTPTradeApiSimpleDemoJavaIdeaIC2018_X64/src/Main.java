/*******************************************************
 * CTPTradeApiSimpleDemoJavaIdeaIC2018_X64
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
	...
	static boolean CreateAndOpenTrade6()
	{
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W64/Api/CTP_v6.3.6_20160606/XFinApi.CTPTradeApi.dll", err);
